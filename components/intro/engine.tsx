...
export function Stage({
  ...
  return (
    ...
    >
      ...
      {/* Portrait-phone hint — a landscape film is a small strip on a tall
          screen; suggest rotating. CSS-gated to small portrait, auto-fades. */}
      <div className="prasm-film-hint" aria-hidden>
        <svg
          width="15"
          height="15"
          viewBox="0 0 24 24"
        ...
        Rotate your device for a bigger view
      </div>
