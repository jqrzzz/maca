/**
 * Child safeguarding & protection policy — public summary of how PRASM protects
 * the children and vulnerable people it works with. Donors, grantmakers, and
 * partner NGOs increasingly require this. REVIEW with the founder; as the team
 * grows, pair it with a fuller internal policy, volunteer vetting, and a named
 * safeguarding lead. Bump `lastUpdated` on changes.
 */
...
// TODO[user]: when the team grows, name a designated safeguarding lead and add volunteer vetting + a full internal policy.
