/**
 * Conflict of interest policy. Public summary of how PRASM keeps decisions free
 * of improper personal influence. REVIEW with the founder; this will anchor the
 * future board's conflict register. Bump `lastUpdated` on changes.
 */
