...
export const note: FieldNote = {
  slug: "building-medical-records-by-hand",
  title: "Building medical records by hand",
  date: "2025-04-05",
  ...
  body: [
    ...
    {
      type: "p",
      text: "I helped him the way I know how. First, I made a record. Doctors are trained to organize information systematically, so that another doctor can pick up where we left off. It is our common language.",
    },
    {
      type: "h",
      text: "A record is more than medicine",
    },
    {
      type: "p",
    ...
    {
      type: "quote",
      text: "This 3,000 baht is much more worthy than 3,000 in another's hand. Money is tricky that way.",
    },
  ],
};
